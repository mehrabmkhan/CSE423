...
def cloud(x, y):
    global cloud_radius
    glColor3f(0.529, 0.808, 0.922)
    midPointCircle(x, y, cloud_radius)
    midPointCircle(x + 25, y, cloud_radius)
    midPointCircle(x + 50, y, cloud_radius)
    midPointCircle(x + 35, y + 20, cloud_radius)

def animate_cloud():
    global cloud_x, cloud_radius
    cloud_speed = 4
...
wind = glutCreateWindow(b"Fish Project")
